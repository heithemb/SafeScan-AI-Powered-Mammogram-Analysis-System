...
Classification:
An SVM model that classifies the segmented regions (e.g., benign vs. malignant).
...
SVM classifier was trained using a combination of CMMD and CBIS-DDSM datasets.
...
# Note
This system is intended as a research prototype and is not yet approved for clinical use.
